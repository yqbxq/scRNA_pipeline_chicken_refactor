...
export MANUAL_ANNOTATION_FILE="${PROJECT_CONFIG_DIR}/manual_annotation.tsv"
export CLUSTER_SELECTION_FILE="${PROJECT_CONFIG_DIR}/cluster_selection.tsv"
...
export RBC_GENE_LIST_FILE="${PROJECT_CONFIG_DIR}/rbc_gene_list.txt"
