...
TMP_ROOT="$(mktemp -d "${TMPDIR:-/tmp}/spatial_region_smoke.XXXXXX")"
...
Rscript "${PIPELINE_ROOT}/workflow/05single_script/spatial/testing/smoke_spatial_region_annotation.R"

echo "smoke_spatial_region_annotation_ok"
