...
TMP_ROOT="$(mktemp -d "${TMPDIR:-/tmp}/spatial_integration_smoke.XXXXXX")"
...
Rscript "${PIPELINE_ROOT}/workflow/05single_script/spatial/testing/smoke_spatial_integration.R"

echo "smoke_spatial_integration_ok"
