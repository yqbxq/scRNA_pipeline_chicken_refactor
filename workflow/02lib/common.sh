...
export MODULE_07A_CELLCHAT_VERSION="${MODULE_07A_CELLCHAT_VERSION:-${MODULE_07A_VERSION:-1.2}}"
...
export ORTHOLOG_CHICKEN_HUMAN_TSV="${ORTHOLOG_CHICKEN_HUMAN_TSV:-${METADATA_DIR}/ortholog_chicken_human.tsv}"
